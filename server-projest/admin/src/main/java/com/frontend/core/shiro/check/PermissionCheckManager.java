...
public class PermissionCheckManager {
    ...
    private com.frontend.core.shiro.check.ICheck defaultCheckFactory = SpringContextHolder.getBean(com.frontend.core.shiro.check.ICheck.class);
    ...
    public PermissionCheckManager(com.frontend.core.shiro.check.ICheck checkFactory) {
